...
@section('admin')
    <div class="side-app">
        ...
        <div class="page-header">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('admin.permissions.index') }}">บริหารจัดการสิทธิ์</a></li>
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <label for="permissionName">เมนู</label>
                                                        <select name="permissionName" class="form-control">
                                                            <option value="" selected>-เลือกเมนู-</option>
                                                            @foreach ($menus as $menu_item)
                                                                <option value="{{ $menu_item->id }}">
                                                                    {{ $menu_item->th_name }}</option>
                                                            @endforeach
                                                        </select>
                                                ...
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <label for="ability">ความสามารถของสิทธิ์</label>
                                                        <select name="ability" class="form-control">
                                                            <option value="" selected>-เลือกความสามารถของสิทธิ์-
                                                            </option>
                                                            <option value="view">ดูรายการข้อมูลทั้งหมด</option>
                                                            <option value="create">สร้าง / เพิ่มข้อมูล</option>
                                                ...
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <label for="permissionGroup">กลุ่มสิทธิ์</label>
                                                        <select name="permissionGroup" class="form-control">
                                                            <option value="" selected>-เลือกกลุ่มสิทธิ์-</option>
                                                            ...
                                                            <option value="data_management">บริหารจัดการ</option>
                                                        </select>
