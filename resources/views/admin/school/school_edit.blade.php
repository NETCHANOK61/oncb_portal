                                    ...
                                    <form id="roleForm" action="" method="POST">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <label for="inputStudent_amt">จำนวนนักเรียนทั้งหมด <span
                                                                class="text-danger">(คำนวณจากจำนวนนักเรียนตามระดับชั้น)</span></label>
                                                        <input type="text"
                                                            class="form-control @error('Student_amt') is-invalid @enderror"
                                                            id="Student_amt" name="Student_amt" disabled />
                                                    </div>
                                                    @error('Student_amt')
                                                        <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                                ...
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <label for="inputLevel_teacher">จำนวนอาจารย์ทั้งหมด</label>
                                                        <input type="text"
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <label
                                                            for="inputTeacher_train">จำนวน/ครูผู้สอนที่ผ่านการอบรมเกี่ยวกับยาเสพติด</label>
                                                        <input type="text"
                                                            class="form-control @error('teacher_train') is-invalid @enderror"
                                                            id="teacher_train" name="teacher_train" />
                                                    </div>
                                                    @error('teacher_train')
                                                        <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                                ...
                                                <div class="col-6">
                                                    @for ($i = 1; $i <= 6; $i++)
                                                        <div class="form-group">
                                                            <label for="inputlevel{{ $i }}_all">จำนวนนักเรียน
                                                                ป.{{ $i }}</label>
                                                            <input type="text"
                                                                class="form-control @error('level{{ $i }}_all') is-invalid @enderror"
                                                                id="level{{ $i }}_all"
                                                                name="level{{ $i }}_all" />
                                                        </div>
                                                        @error('level{{ $i }}_all')
                                                ...
                                                <div class="col-6">
                                                    @for ($i = 1; $i <= 6; $i++)
                                                        <div class="form-group">
                                                            <label
                                                                for="inputMattayom{{ $i }}_all">จำนวนนักเรียน
                                                                ม.{{ $i }}</label>
                                                            <input type="text"
                                                                class="form-control @error('mattayom{{ $i }}_all') is-invalid @enderror"
                                                                id="mattayom{{ $i }}_all"
                                                                name="mattayom{{ $i }}_all" />
                                                        </div>
                                                        @error('mattayom{{ $i }}_all')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    @endfor
                                                </div>
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <label
                                                            for="inputLevel_bachelor">จำนวนนักเรียน/นักศึกษาระดับปริญญาและอนุปริญญา</label>
                                                        <input type="text"
                                                            class="form-control @error('level_bachelor') is-invalid @enderror"
                                                            id="level_bachelor" name="level_bachelor" />
                                                    </div>
                                                    @error('level_bachelor')
                                                        <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <label for="inputLevel_achiva">จำนวนนักเรียน ปวช./ปวส.</label>
                                                        <input type="text"
                                                            class="form-control @error('level_achiva') is-invalid @enderror"
                                                            id="level_achiva" name="level_achiva" />
                                                    </div>
                                                    @error('level_achiva')
                                                        <span class="text-danger">{{ $message }}</span>
                                                    @enderror
