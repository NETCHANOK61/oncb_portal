    ...
    <div class="side-app">
        ...
        <div class="row">
            ...
            <div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="col-md-12">
                        <form id="roleForm" action="{{ route('admin.store.type') }}" method="POST">
                            @csrf
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                name="type_name" placeholder="หัวข้อ" />
                                        </div>
                                        @error('type_name')
            ...
            'ion-ios7-bookmarks-outline' => 'ion-ios7-bookmarks-outline',
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" id="description" name="description" rows="3" placeholder="คำอธิบายเพิ่มเติม"></textarea>
                                        </div>
                                    </div>
                                </div>
