...
<body class="app sidebar-mini rtl">
    ...
    <script>
        ...
        function formatIonic(icon) {
            return $('<span><i class="side-menu__icon ion ' + $(icon.element).data('icon') + '"></i> ' + icon.text +
                '</span>');
        };
        ...
        $('.select2-ionic').select2({
            width: "100%",
            templateSelection: formatIonic,
            templateResult: formatIonic
        });
